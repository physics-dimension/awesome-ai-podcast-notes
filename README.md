...
![Notes](https://img.shields.io/badge/notes-757-2f6f5e) ![Channels](https://img.shields.io/badge/channels-16-4b7bec) ![License](https://img.shields.io/badge/license-CC%20BY%204.0-6c5ce7) ![Updated](https://img.shields.io/badge/updated-daily-f39c12)

一个面向 AI 从业者、产品经理、研究者和独立开发者的 AI 长播客 / YouTube 深度笔记开放资料库。

它不是一个单纯的播客列表，而是把长音频、长视频、技术访谈和 AI 领域对话转成可检索、可引用、可复盘的 Markdown 笔记库。
...
- 想系统跟踪 AI 产品、模型、Agent、创业和工程实践的人；
- 想快速判断一集长播客是否值得完整收听的人；
- 想把公开访谈、课程、分享转成可复盘知识库的人；
- 想基于公开内容做检索、主题索引或二次整理的人。

## 三种文稿版本

- **深度笔记**：默认入口，适合阅读、复盘和引用。
- **结构化文稿**：更接近提纲 / 数据结构，适合后续做主题索引、检索或再加工。
- **原始文稿**：尽量保留转写文本，适合核对细节和追溯上下文。

不是每一集都有三种版本；具体以每篇笔记顶部的“版本”区和 `data/episodes.json` 为准。

## 浏览入口

- [按播客 / 博主归档](channels/README.md)
- [按时间线归档](timeline/README.md)
- [主题索引](topics/README.md)
- [机器可读数据](data/episodes.json)

## 精选频道

### [李弘毅](channels/李弘毅/README.md) · 253 篇

- 2026-05-10 · [AI 要跨越盧比孔河了嗎？自我成長的 AI 離我們多遠？](channels/李弘毅/2026-05-10-ai-要跨越盧比孔河了嗎-自我成長的-ai-離我們多遠-s06mSAGN4gM.md)
...
### [Latent Space](channels/latent-space/README.md) · 69 篇
...
### [Greg Isenberg](channels/greg-isenberg/README.md) · 57 篇
...
### [Lenny's Podcast](channels/lenny's-podcast/README.md) · 42 篇
...
### [张晓珺](channels/张晓珺/README.md) · 42 篇
...
- [data/episodes.json](data/episodes.json)：完整公开索引；
- [data/latest.json](data/latest.json)：最近 50 条公开记录；
- [docs/DATA_SCHEMA.md](docs/DATA_SCHEMA.md)：字段说明；
- [docs/GENERATION_POLICY.md](docs/GENERATION_POLICY.md)：生成、版权和质量边界。

本仓库由 YouTube AI Deep Reader 自动生成并每日刷新。公开版本不会暴露私有 Notion 链接，只保留原始来源链接，方便读者回到原视频或播客核对。

## 内容边界

这些内容是 AI 生成的学习辅助资料，不等同于人工校对后的正式稿。它可能包含转写错误、摘要偏差、缺失上下文，或原始内容本身已经过时。引用重要观点前，请优先核对原始来源。

## 参与贡献

欢迎通过 issue 或 pull request 参与：

- 推荐高质量 AI 播客、YouTube 频道或长访谈；
- 修正标题、频道、日期、链接等元数据；
- 补充主题标签、专题集合和中文 / 英文说明；
- 标记需要人工复核的笔记。

更多说明见 [CONTRIBUTING.md](CONTRIBUTING.md)、[ROADMAP.md](ROADMAP.md) 和 [docs/CURATION_GUIDE.md](docs/CURATION_GUIDE.md)。
